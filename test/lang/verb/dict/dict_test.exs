defmodule JpKatsuyouTest.Verb.Dict do
  ...
  describe "Dict" do
    ...
    #   assert Verb.dic_present(%{kumi: "ichidan", verb: "食べる"}) == "食べた"
    #   assert Verb.dic_present(%{kumi: "godan", verb: "話す"}) == "話した"
    #   assert Verb.dic_present(%{kumi: "irregular", verb: "する"}) == "した"
    #   assert Verb.dic_present(%{kumi: "irregular", verb: "来る"}) == "来た"
    # end
